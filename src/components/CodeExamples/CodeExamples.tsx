    ...
    return <div className="code-example">
        <div className={codeExampleClass} id="firstBlock">
            ...
            <pre className="code-example__code">
                <span className="red">type:</span> <span>Project <span className="grey">{'{'}</span></span>
                {'\n  '}
                ...
                {'\n  '}
                <span className="blue">contributors:</span> <span className="grey">[</span><span className="yellow">User</span><span className="grey">]</span>
                {'\n'}
        ...
        <div className={codeExampleClass} id="secondBlock">
            ...
            <pre className="code-example__code">
                <span className="grey">{'{'}</span>
                {'\n  '}
                project<span className='grey'>{'('}</span><span className='blue'>name</span><span className='grey'>:</span>
                <span className='pink'>"GraphQL"</span><span className='grey'>{')'}</span> <span className='grey'>{'{'}</span>
                {'\n    '}
                tagline
                {'\n  '}
                <span className='grey'>{'}'}</span>
        ...
        <div className={codeExampleClass} id="thirdBlock">
            ...
            <pre className="code-example__code">
                <span className="grey">{'{'}</span>
                {'\n  '}
                <span className='blue'>"project"</span><span className='grey'>:</span> <span className='grey'>{'{'}</span>
                {'\n    '}
                <span className='blue'>"tagline"</span><span className='grey'>:</span>
